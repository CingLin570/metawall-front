<template>
    <section>
      <nav
        class="navbar navbar-expand-lg navbar-light fixed-top border-bottom border-3 border-dark
        bg-white"
      >
        <div class="container px-lg-12">
          ...
          <div class="d-flex align-items-center">
            <img src="~@/assets/img/user1.png" alt="user1" class="me-2 img-fluid" />
            <div class="dropdown bg-white me-2">
              ...
              <ul
                class="dropdown-menu py-0 border border-dark border-2 rounded-0
                menu-shadow"
                aria-labelledby="dropdownMenuButton1"
              >
                <li class="border-bottom border-dark border-2">
                  <router-link to="/personal" class="dropdown-item">我的貼文牆</router-link>
                </li>
                <li class="border-bottom border-dark border-2">
                  <router-link to="/profile" class="dropdown-item">修改個人資料</router-link>
                </li>
